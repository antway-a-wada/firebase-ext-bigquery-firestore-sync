 ...
 */
export function transformRow(row: BigQueryRow, config: ExtensionConfig): FirestoreDocument | null {
  try {
 ...
 */
export function transformRows(rows: BigQueryRow[], config: ExtensionConfig): FirestoreDocument[] {
